  ...
  return (
    <div className="w-full p-6 md:p-12">
      ...
      <div>
        ...
        <div className="text-xl text-zinc-400 grid justify-items-center md:justify-items-start print:justify-items-start leading-8">Sep 2020 - Present</div>
      ...
      <div className="mt-8 print:mt-6">
        <div className="flex items-center flex-col-reverse md:flex-row print:flex-row mb-5">
          <div className="basis-2/3 text-2xl md:text-3xl leading-8">Wistron Corporation</div>
          <div className="basis-1/3 grid justify-items-start md:justify-items-end print:justify-items-end"><img src={WISTRON_LOGO} className="h-10" /></div>
        </div>
        <div className="text-2xl text-yellow-500 grid justify-items-center md:justify-items-start print:justify-items-start leading-8">RD Senior Engineer</div>
        <div className="text-xl text-zinc-400 grid justify-items-center md:justify-items-start print:justify-items-start leading-8">Mar 2015 – Aug 2020</div>
        <ul className="mt-5 ml-2 list-outside md:list-inside print:list-inside list-disc leading-6 md:leading-8 text-lg">
